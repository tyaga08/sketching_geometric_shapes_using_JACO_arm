function jacofwdplot(theta1,theta2,theta3,theta4,theta5,theta6)
...
%t1=-6.0782;t2=0.7617;t3=-0.8628;t4=-4.5158;t5=5.8623;t6=1.6487;
...
wrist1=line([P40(1) P50(1)],[P40(2) P50(2)], [P40(3) P50(3)], 'Marker','o','LineWidth',4,'Color','k');
wrist2=line([P50(1) P60(1)],[P50(2) P60(2)], [P50(3) P60(3)], 'Marker','o','LineWidth',4,'Color','k');
wrist3=line([P60(1) P70(1)],[P60(2) P70(2)], [P60(3) P70(3)], 'Marker','o','LineWidth',4,'Color','k');
endeff=line([P70(1) P80(1)],[P70(2) P80(2)], [P70(3) P80(3)], 'Marker','o','LineWidth',4,'Color','r');

endpoint=line([P80(1) P80(1)],[P80(2) P80(2)],[P80(3) P80(3)], 'Marker','o','LineWidth',4,'Color','g');
